...
const DATA = {
  ...
  artifacts: {
    ...
    bleed:     { name: '渇血の棘',         desc: '刀・オービットブレード・スローイングアックスが出血(5秒)を付与。出血スタック 1 につき受けるダメージ +5%(最大スタックは対象武器の所持数に応じて 6/12/20)' },
    ...
    critdmg:   { name: '処刑人の刻印',     desc: 'クリティカルダメージ +50%。非クリティカルダメージ -20%' },
