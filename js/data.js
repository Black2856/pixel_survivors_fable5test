...
const DATA = {
  ...
  statLabels: {
    ...
    burn: '燃焼/s', dur: '持続', slow: '速度倍率', pull: '吸引力',
  },
  ...
  artifacts: {
    ...
    bleed:     { name: '渇血の棘',         desc: '刀・オービットブレード・スローイングアックスが出血(5秒)を付与。出血スタック 1 につき受けるダメージ +5%(最大6スタック)' },
    ...
    horizon:   { name: '事象の地平線',     desc: 'ブラックホールのダメージ -50%。持続時間 +100%' },
